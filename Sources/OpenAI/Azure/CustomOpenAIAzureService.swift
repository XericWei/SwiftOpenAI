...
// MARK: - CustomOpenAIAzureService support custom doamin

public final class CustomOpenAIAzureService: OpenAIService {
  public init(
    ...
    debugEnabled: Bool)
  {
    ...
    openAIEnvironment = OpenAIEnvironment(
      baseURL: overrideBaseURL ?? "https://\(azureConfiguration.resourceName)/openai.azure.com",
      proxyPath: nil,
      version: nil)
